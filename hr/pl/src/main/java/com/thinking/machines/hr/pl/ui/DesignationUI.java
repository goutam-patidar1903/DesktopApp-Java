...
setAppearance();
addListeners();
setViewMode(); //outer class method
designationPanel.setViewMode();  //inner class method
}
private void initComponents()    //will create only objects in this method
{
...
container.setLayout(null);  //otherwise by default it will be border layout
...
lm=0;
tm=0;
titleCaptionLabel.setBounds(lm+5,tm+20,110,30);
...
buttonsPanel.setBounds(50,tm+20+30,465,75);
