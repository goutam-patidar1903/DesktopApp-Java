...
companyNamePara.add("Goms Corporation");
...
Paragraph reportTitlePara=new Paragraph("List of designaitons");
...
float topTableColumnWidths[]={1,6};
float dataTableColumnWidths[]={1,6};
int sno,r,pageSize;
pageSize=14;
...
//create footer
doc.add(dataTable);
doc.add(new Paragraph("Software by : Goutam Patidar"));
